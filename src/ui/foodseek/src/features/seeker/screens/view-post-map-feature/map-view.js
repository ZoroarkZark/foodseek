...
import { BottomSheetContainer } from './search-bottom-sheet.js'
...
export const Map = ({ navigation, route }) => {
    ...
    const {location, deviceLocation, getLocation, search: setLocation, } = useContext( LocationContext )
    ...
    }, [ deviceLocation, location, setLocation ] )
