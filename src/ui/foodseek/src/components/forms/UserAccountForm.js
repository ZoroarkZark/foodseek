...
// contains the input fields required for seekers specifically
const UserAccountForm = (props) => {
    return (
        <>
            ...
            <TransitPickerInput
                value={props.pTravel}
                onValueChange={props.setPTravel}
            >
                Choose one...
            </TransitPickerInput>
        </>
